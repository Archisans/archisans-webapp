...
const WORKER_TEMPLATE = {
  ...
  services: [
    {
      ...
      type: "hour",
      notes:
        "Provides modern and functional home layouts, interior planning, and 3D renderings.",
      licenseImg:
    ...
    },
    {
      ...
      type: "day",
      notes:
        "Provides high-quality brickwork, stone masonry, and general construction support.",
      licenseImg:
        "https://images.unsplash.com/photo-1599058917217-1f2d2dbb2c97",
      verified: true,
    ...
    },
    {
      ...
      type: "hour",
      notes:
        "Provides solutions for water supply, irrigation, drainage systems, and sustainable water management.",
      licenseImg:
    ...
    },
    {
      ...
      type: "project",
      notes:
        "Provides safe and efficient demolition services for residential, commercial, and industrial buildings.",
      licenseImg:
    ...
    },
    {
      ...
      type: "hour",
      notes:
        "Provides fabrication and installation of aluminium windows, doors, partitions, and decorative structures.",
      licenseImg:
    ...
    },
    {
      ...
      type: "hour",
      notes:
        "Provides installation and maintenance of CCTV cameras, alarm systems, and access control solutions for residential and commercial properties.",
      licenseImg:
    ...
    },
    {
      ...
      type: "hour",
      notes:
        "Provides guidance on design projects, 3D modeling, rendering, and presentation for architecture students.",
      licenseImg:
    ...
    },
    {
      ...
      type: "hour",
      notes:
        "Assists with obtaining building permits, legal approvals, and compliance documentation for residential and commercial projects.",
      licenseImg:
  ...
  projects: [
    {
      ...
      phnno: "65469271052",
      description:
        "Designed a modern residential home with functional layouts and sustainable features.",
      images: [
    ...
    },
    {
      ...
      phnno: "9876543210",
      description:
        "Executed high-quality brickwork and masonry for a commercial building.",
      images: [
    ...
    },
    {
      ...
      phnno: "1234567890",
      description:
        "Developed an efficient irrigation and drainage system for a residential complex.",
      images: [
        "https://images.unsplash.com/photo-1581091870620-5d4f4c77d1a1",
        "https://images.unsplash.com/photo-1590073242580-3b3b6c1f4e4c",
      ],
    ...
    },
    {
      ...
      phnno: "7896541230",
      description:
        "Performed safe and efficient demolition for a multi-storey building.",
      images: [
        "https://images.unsplash.com/photo-1600585154340-be6161a56a0c",
    ...
    },
    {
      ...
      phnno: "4561237890",
      description:
        "Installed aluminium windows and doors with custom designs for a luxury villa.",
      images: [
        "https://images.unsplash.com/photo-1593642634367-d91a135587b5",
    ...
    },
    {
      ...
      phnno: "3216549870",
      description:
        "Installed CCTV cameras and access control systems for a commercial property.",
      images: [
        "https://images.unsplash.com/photo-1591696331115-7a4a68d25f50",
    ...
    },
    {
      ...
      phnno: "6549873210",
      description:
        "Provided 3D modeling and design assistance for architecture students’ projects.",
      images: [
        "https://images.unsplash.com/photo-1522202176988-66273c2fd55f",
        "https://images.unsplash.com/photo-1504384308090-c894fdcc538d",
      ],
    ...
    },
    {
      ...
      phnno: "7891234560",
      description:
        "Assisted a commercial project with building permits, approvals, and compliance documentation.",
      images: [
        "https://images.unsplash.com/photo-1590073242580-3b3b6c1f4e4c",
        "https://images.unsplash.com/photo-1581091870620-5d4f4c77d1a1",
      ],
  ...
  workerReviews: [
    ...
    },
    {
      ...
      review:
        "Exceptional experience! The work was modern, practical, and visually appealing.",
    },
    {
      id: 3,
      name: "Priya Nair",
      ...
      review:
        "Very creative and attentive. They incorporated our ideas perfectly into a functional design.",
    },
    {
      id: 4,
      name: "Arjun Menon",
      ...
      review:
        "Professional and reliable team. The output exceeded our expectations in every way.",
    },
  ],
};
